...
import 'package:chad_hr/model/DeployedForm.dart';
...
class _FormsState extends State<Forms> {
  ...
  OpenFormCreator(BuildContext context, _FormsState state) {
    showDialog(
        context: context,
  ...
  OpenFormEditor(BuildContext buildContext, int formIndex, _FormsState state) {
